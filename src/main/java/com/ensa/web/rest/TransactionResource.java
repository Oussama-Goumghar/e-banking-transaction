    ...
    public ResponseEntity<Transaction> partialUpdateTransaction(
        ...
        Optional<Transaction> result = transactionRepository
            ...
            .map(existingTransaction -> {
                ...
                if (transaction.getDateEmission() != null) {
                    existingTransaction.setDateEmission(transaction.getDateEmission());
                }
                if (transaction.getStatus() != null) {
                    existingTransaction.setStatus(transaction.getStatus());
                }
                if (transaction.getPin() != null) {
                    existingTransaction.setPin(transaction.getPin());
                }
